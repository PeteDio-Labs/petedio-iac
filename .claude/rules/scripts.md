...
- `claude -p` skips the trust dialog. Bound it with `timeout`, under a larger `TimeoutStartSec` (docs/GOTCHAS.md: "Claude Code as a service — the Claude host (247) (PET-396)").
